  ...
  physics: {
    ...
    mascot: {
      ...
      trail: {
        ...
        activeAfterBounceMs: 1000,  // Trail visible for X ms after hitting gelato (0 = always on)
        endFadeDurationMs: 300,     // Duration of fade-out when trail expires (0 = instant disappear)
